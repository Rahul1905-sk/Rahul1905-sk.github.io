...
import { FaWhatsapp, FaYoutube, FaInstagram, FaGithub, FaLinkedinIn } from "react-icons/fa";
...
const Contact = () =>{
    ...
    return(
                ...
                <div className="flex flex-col justify-between md:py-14" data-aos="fade-right">
                    ...
                    <div className="flex flex-col gap-5 text-white mt-10 text-sm sm:mt-16 md:text-[15px] md:text-sm ">
                        <div className="inline-flex space-x-3 items-center">
                            <FaPhoneAlt/>
                            <span>+91 8770182248</span>
                        </div>

                        <div className="inline-flex space-x-3 items-center">
                            <FaEnvelope/>
                            <span>rahul1905.sk@gmail.com</span> 
                        </div>
                    ...
                    <div className="flex flex-row gap-x-6 text-white text-2xl 
                        ...
                        <a href = "https://www.linkedin.com/in/rahul-singh-kushwah-6a664b172"><FaLinkedinIn/></a>

                        <a href = "https://github.com/Rahul1905-sk"><FaGithub/></a>

                        <a href = "mailto:rahul1905.sk@gmail.com"><SiGmail/></a>

                        <a href = "https://api.whatsapp.com/send/?phone=8770182248&text&app_absent=0"><FaWhatsapp/></a>
        ...
        <div className="w-full bg-slate-900 text-center items-center py-5 px-3 absolute">
            ...
            <span className="text-cyan-400"> Rahul Singh Kushwah</span> | ©️ 2023 All rights reserved.</h1>
        </div>
